...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(KEY11), key11ISR, CHANGE); //TODO: attach interrupts for all keys
  ...
  attachInterrupt(digitalPinToInterrupt(KEY21), key21ISR, CHANGE); //TODO: attach interrupts for all keys
